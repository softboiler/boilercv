...
EXAMPLE_CONTOURS = paths.params.paths.examples / f"{EXAMPLE_VIDEO_NAME}.h5"
# TODO: Source the ROI from the dataset.
EXAMPLE_ROI = paths.params.paths.examples / f"{EXAMPLE_VIDEO_NAME}_roi.yaml"


def get_images() -> DA:
    """Get images."""
    with open_dataset(paths.params.paths.examples / f"{EXAMPLE_VIDEO_NAME}.nc") as ds:
