...
<!-- Please verify the issue is present in the latest version by installing it with `pip install boilercv==0.0.5` and checking that the bug is still there #} -->

- [ ] This bug affects version `0.0.5` of `boilercv`.
