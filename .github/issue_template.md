...
<!-- Please verify the issue is present in the latest version by installing it with `pip install boilercv==2024.1.3` and checking that the bug is still there #} -->

- [ ] This bug affects version `2024.1.3` of `boilercv`.
